...
# Inside your load_payroll function
        for row_idx, row_data in enumerate(self.rows):
                ...
                self.tableWidget.setItem(row_idx, 5, QTableWidgetItem(str(round(regular_salary, 2))))  # Regular Salary
                self.tableWidget.setItem(row_idx, 6, QTableWidgetItem(str(round(overtime_salary, 2))))  # Overtime Salary
                self.tableWidget.setItem(row_idx, 7, QTableWidgetItem(str(round(total_salary, 2))))  # Total Salary
